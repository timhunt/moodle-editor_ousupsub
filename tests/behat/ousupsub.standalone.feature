...
Feature: ousupsub subscript button
  ...
  Scenario: Applying Subscript and Superscript on text
    ...
    And I click on "Superscript" "button"
    Then I should see "<span>Superscript</span> and <sub>Subscript</sub>" in the "Both Superscript and Subscript allowed" ousupsub editor
    ...
    And I click on "Subscript" "button"
    Then I should see "<span>Superscript</span> and <span>Subscript</span>" in the "Both Superscript and Subscript allowed" ousupsub editor

    # Re-apply subscript
    When I select the range "'span:nth-child(2)', 0, 'span:nth-child(2)', 9" in the "Both Superscript and Subscript allowed" ousupsub editor
    And I click on "Subscript" "button"
    Then I should see "<span>Superscript</span> and <span><sub>Subscript</sub></span>" in the "Both Superscript and Subscript allowed" ousupsub editor

    # Re-apply superscript
    When I select the range "'span', 0, 'span', 11" in the "Both Superscript and Subscript allowed" ousupsub editor
    And I click on "Superscript" "button"
    Then I should see "<span><sup>Superscript</sup></span> and <span><sub>Subscript</sub></span>" in the "Both Superscript and Subscript allowed" ousupsub editor

    # Return subscript to normal again
    When I select the range "'span:nth-child(2) > sub', 0, 'span:nth-child(2) > sub', 9" in the "Both Superscript and Subscript allowed" ousupsub editor
    And I click on "Subscript" "button"

    # Apply subscript again
    And I click on "Subscript" "button"
    Then I should see "<span><sup>Superscript</sup></span> and <span><span><sub>Subscript</sub></span></span>" in the "Both Superscript and Subscript allowed" ousupsub editor

    # Return superscript to normal again
    When I select the range "'span > sup', 0, 'span > sup', 11" in the "Both Superscript and Subscript allowed" ousupsub editor
    And I click on "Superscript" "button"

    # Apply superscript again
    And I click on "Superscript" "button"
    Then I should see "<span><span><sup>Superscript</sup></span></span> and <span><span><sub>Subscript</sub></span></span>" in the "Both Superscript and Subscript allowed" ousupsub editor
