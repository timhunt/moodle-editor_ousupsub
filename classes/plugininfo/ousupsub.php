...
class ousupsub extends base {
    ...
    public static function get_manage_url() {
        return new \moodle_url('/admin/settings.php', array('section'=>'editorsettingsousupsub'));
    }
     ...
     * It's used to get the setting links in the ousupsub sub-plugins table.
     *
     * @return null|string the settings section name.
     */
    public function get_settings_section_name() {
        return 'ousupsub_' . $this->name . '_settings';
    }
}
