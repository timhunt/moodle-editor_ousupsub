...
* Further work on cleaning up html output: Only sup/sub html tags and
  alphanumeric text should be allowed.
* virtual keyboard: If you tap on the icons in a mobile device you lose the
  selection of the selected text. to allow up and down gestures to apply sup and
  sub on mobile devices.

Questions
* icons: The atto editor has larger icons with less contrast than the existing
  supsub editor. Which should be used.
