YUI.add('moodle-editor_ousupsub-menu', function (Y, NAME) {
...
/**
 * A Menu for the ousupsub editor.
 *
 * @module     moodle-editor_ousupsub-menu
 * @submodule  menu-base
...
var MENUDIALOGUE = '' +
        '<div class="open {{config.buttonClass}} ousupsub_menu" ' +
            'style="min-width:{{config.innerOverlayWidth}};">' +
            '<ul class="dropdown-menu">' +
                '{{#each config.items}}' +
                    '<li role="presentation" class="ousupsub_menuentry">' +
...
/**
 * A Menu for the ousupsub editor used in Moodle.
 *
...
Y.extend(Menu, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        bb.addClass('editor_ousupsub_controlmenu');
        bb.addClass('editor_ousupsub_menu');
    ...
    _setupHandlers: function() {
        ...
        this._menuHandlers.push(
            ...
            contentBox.delegate('key', this._chooseMenuItem, '32, enter', '.ousupsub_menuentry', this),
...
Y.Base.modifyAttrs(Menu, {
     ...
     * @type Array
     * @default editor_ousupsub_menu
     */
    extraClasses: {
        value: [
            'editor_ousupsub_menu'
        ]
    },
...
Y.namespace('M.editor_ousupsub').Menu = Menu;
