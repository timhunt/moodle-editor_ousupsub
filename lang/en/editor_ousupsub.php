...
$string['pluginname'] = 'ousupsub HTML editor';
$string['subplugintype_ousupsub'] = 'ousupsub plugin';
$string['subplugintype_ousupsub_plural'] = 'ousupsub plugins';
$string['settings'] = 'ousupsub toolbar settings';
